...
def feedback(request):
    if request.method == 'POST':
        ...
        send_mail('New feedback', 'sender:' + receiving_mail + '\nfeedback:' + feedback, 'mailtoallwinraju@gmail.com',
                  ['allwindicaprio@gmail.com'], fail_silently=False)
        send_mail('greetings', 'Hi, Thank you for subscribing!', 'mailtoallwinraju@gmail.com', [receiving_mail],
                  fail_silently=False)
...
def blog(request):
    response = requests.get("http://allwinblog.pythonanywhere.com/api/post/")
